\chapter{All 1051 examples of prs in these texts are found in the following sentences:}
...
\textit{māčo, beɫē} \\ 
\gll m-āč-o beɫē \\ 
 \textsc{ind-}say\textsc{.prs}\textsc{-3sg} yes \\ 
\glt `She said, ‘Yes!’'
\z 
...
\textit{tiroq misāno} \\ 
\gll tiroq mi-sān-o \\ 
 progress \textsc{ind-}buy\textsc{.prs}\textsc{-3sg} \\ 
\glt `It will make progress.'
\z 
...
\ea \label{ŽP.15}
\textit{miqdārē yāwo pene} \\ 
\gll miqdārē ∅-yāw-o pene \\ 
 a\_little \textsc{ind-}arrive\textsc{.prs}\textsc{-3sg} to \\ 
...
\ea \label{ŽP.81}
\textit{milo miqdārē weno} \\ 
\gll mi-l-o miqdārē ∅-wen-o \\ 
 \textsc{ind-}go\textsc{.prs}\textsc{-3sg} a\_little \textsc{ind-}read\textsc{-3sg} \\ 
...
\ea \label{ŽP.151}
\textit{nitqiš bīnīyo} \\ 
\gll nitq=iš bīnīye-o \\ 
 speech\textsc{=3sg} close\textsc{.prs}.pass\textsc{-3sg} \\ 
...
\textit{fermāwo čī} \\ 
\gll ∅-fermāw-o čī \\ 
 \textsc{ind-}say.prs\textsc{-3sg} why \\ 
...
\textit{yewāšē zil bo} \\ 
\gll yewāšē zil ∅-b-o \\ 
 then big \textsc{ind-}be\textsc{.prs}\textsc{-3sg} \\ 
\glt `Then, he grew up.'
\z 
...
\ea \label{ŽH.43}
\textit{bero miđoš pene} \\ 
\gll ∅-ber-o mi-đe-o=š pene \\ 
 \textsc{ind-}take\textsc{.prs}\textsc{-3sg} \textsc{ind-}give\textsc{.prs}\textsc{-3sg}\textsc{=3sg} to \\ 
\glt `She took it [and] gave it to him (Hayas).'
\z 
...
\ea \label{ŽH.90}
\textit{māčo, čēšū čēš?’} \\ 
\gll m-āč-o čēš=ū čēš \\ 
 \textsc{ind-}say\textsc{.prs}\textsc{-3sg} what=and what \\ 
\glt `She said, ‘What [colours]? [Lit. what and what]’'
\z 
...
\ea \label{ŽH.96}
\textit{tāk tāk miđoš pene} \\ 
\gll tāk tāk mi-đe-o=š pene \\ 
 one one \textsc{ind-}give\textsc{.prs}\textsc{-3sg}\textsc{=3sg} to \\ 
